    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#f0f4ff' }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-3">
          <Link href="/" className="flex items-center gap-2 min-w-0">
            ...
            <span className="font-black text-gray-900 text-sm sm:text-base tracking-tight">OriginalSolars</span>
          </Link>
          <Link
            href="/"
      ...
      <footer style={{ background: 'white', borderTop: '1px solid #e5e7eb', padding: '20px 24px' }}>
        <div className="max-w-6xl mx-auto flex items-center justify-center gap-2">
          ...
          <span style={{ color: '#9ca3af', fontSize: 12 }}>© {new Date().getFullYear()} OriginalSolars</span>
        </div>
      </footer>
