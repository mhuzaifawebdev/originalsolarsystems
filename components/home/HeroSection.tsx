...
function PhoneMockup() {
  return (
    <div className="relative animate-float select-none" style={{ width: 260 }}>
        ...
        <div className="absolute inset-[6px] rounded-[2.3rem] overflow-hidden flex flex-col" style={{ background: '#080f1e' }}>
          ...
          <div className="mx-4 my-4 rounded-2xl border border-emerald-500/25 p-3.5 flex items-center gap-3" style={{ background: 'rgba(16,185,129,0.07)' }}>
            ...
            <div>
              ...
              <div className="text-white/40 text-[11px] mt-0.5">Verified in 0.3s · 400W</div>
            </div>
      ...
      <div className="absolute -right-6 top-16 bg-white rounded-2xl shadow-xl px-3.5 py-2.5 flex items-center gap-2.5 animate-float-slow border border-gray-100">
        ...
        <div>
          <div className="text-[11px] font-bold text-gray-900">Original Panel</div>
          <div className="text-[10px] text-gray-400">Jinko · 400W</div>
        </div>
      </div>
